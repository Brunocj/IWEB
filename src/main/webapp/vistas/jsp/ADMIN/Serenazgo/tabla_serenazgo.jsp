                ...
                <div class="content-wrapper" style ="background-color: #FFEBEE;"> <!--Cambiar al color mas claro-->
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <div style="display: flex; justify-content: space-between;">
                            <div style="display: flex; flex-direction: column; ">
                                <h2 class="tabla-title" style ="color:#000f22;">Personal de Serenazgo</h2>  <!--Cambiar el titulo de la tabla-->

                                <div style="display: flex; gap:30px;margin-top: 10px;">

                                    <div style="display: flex; gap:10px;">

                                        <p style ="color:black; align-self: center; margin-bottom: 0px;font-size: 15px">Filtrar por turno :</p>
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: center;">
                                        <button id="limpiarFiltros" class="btnTable" style="display: flex; align-items: center;" onclick="window.location.href='serenazgoRegistro.jsp'">
                                            Agregar Personal
                    ...
                    <table id="miTabla" class="table" style="margin-bottom:15px;">
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td>Mañana</td>
                            <td><a href ="datosSerenazgo.jsp" class ="mdi mdi-eye" style ="color: #6c7293; font-size: 20px;"></a></td>
                            <td><a href ="editarSerenazgo.jsp" class ="mdi mdi-lead-pencil" style ="color: #6c7293; font-size: 20px;"></a></td>
