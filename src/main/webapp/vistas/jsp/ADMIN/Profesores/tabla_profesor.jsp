...
<%
    ...
    List<String> listaCursos = (List<String>) request.getAttribute("listaCursos");
    List<String> listaAreas = (List<String>) request.getAttribute("listaAreas");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                                    ...
                                    <div style="display: flex; flex-direction: column; ">
                                        ...
                                        <div style="display: flex; gap:30px;margin-top: 10px;">
                                            ...
                                            <div style="display: flex; gap:10px;">
                                                <p style="color:black; align-self: center; margin-bottom: 0px;font-size: 15px">Filtrar por :</p>
                                                <select id="filtroTipo" style="border-color: #DFDFDF; border-radius: 6px; padding:5px; outline: none; height: 40px; margin-top: 10px;">
                                                    <option value="">Seleccionar</option>
                                                    <option value="curso">Curso</option>
                                                    <option value="area">Área</option>
                                                </select>
                                            </div>
                                            <div id="filtroCursoDiv" style="display: none; gap:10px;">
                                                <p style="color:black; align-self: center; margin-bottom: 0px;font-size: 15px">Curso :</p>
                                                <select id="filtroCurso" style="border-color: #DFDFDF; border-radius: 6px; padding:5px; outline: none; height: 40px; margin-top: 10px;">
                                            ...
                                            <div id="filtroAreaDiv" style="display: none; gap:10px;">
                                                <p style="color:black; align-self: center; margin-bottom: 0px;font-size: 15px">Área :</p>
                                                <select id="filtroArea" style="border-color: #DFDFDF; border-radius: 6px; padding:5px; outline: none; height: 40px; margin-top: 10px;">
                                                    <option value="">Mostrar Todos</option>
                                                    <%
