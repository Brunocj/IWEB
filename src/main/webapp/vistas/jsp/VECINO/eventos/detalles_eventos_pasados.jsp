        ...
        <div class="main-panel">
            <div class="content-wrapper" style ="background-color: #d6e9ff;"> <!--Cambiar al color mas claro-->
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="container-cards">
                                ...
                                <label for="c1" class="cardTransicion">
                                </label>
                                <input type="radio" name="slide" id="c2" >
                                <label for="c2" class="cardTransicion">
                                </label>
                            </div>
                        </div>
                    ...
                    <a href="${pageContext.request.contextPath}/Vecino?action=eventosPasados" class="btn btn-primary fixed-button" style="position: absolute; bottom: 20px; right: 20px; font-size: 18px; font-weight: bold;">Volver a Eventos</a> <!-- Alineación del botón a la derecha -->
                </div>
