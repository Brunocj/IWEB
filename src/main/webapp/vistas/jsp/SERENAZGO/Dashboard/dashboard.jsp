        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                                ...
                                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                    <div class="navbar-profile">
                                        <div class="Header-nav-item">
                                            <h2 class="mb-0 d-none d-sm-block navbar-profile-name" style="margin-right: -30px; font-size: 23px; font-weight:500; cursor: default; text-align: right;">NOMBRE DEL SERENAZGO</h2>
                                            <h5 class="mb-0 d-none d-sm-block navbar-profile-name" style="margin-right: -30px; font-size: 15px; font-weight:500; cursor: default;">Serenazgo de San Miguel, Lima</h5>
                                        </div>
                ...
                <div class="main-panel">
                    <div>
                        <div class="content-wrapper" style="background-color: #000f22;"> <!--Cambiar al color mas claro-->
                            <!--CONTENIDO-->
                            <div class="main-panel">
