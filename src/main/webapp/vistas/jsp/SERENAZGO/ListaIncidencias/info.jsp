  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
          <div class="card">
            <h1 style="text-align: center;">Información de incidencias pasadas</h1>
            <h3>Bienvenido, la información registrada por el personal luego del proceso de la incidencia se muestra a continuación. Seleccione "Finalizar" si desea regresar a la lista de incidencias pasadas.</h3>
            <h3>Información:<h3>

            <!-- Radios de categorías -->
            
          <div class="info">
            <h4 style="text-align: justify;">De acuerdo a la información ingresada por el serenazgo de turno Ricardo Calderón Rodríguez de código 71761570. Esta incidencia se encuentra en proceso. Fue generada por el miembro Manuel Augusto Yarlequé Medina. La situación ocurrió en la ubicación avenida universitaria 1020. Para ella el serenazgo solicitó ambulancia, policía y bomberos. La policía se solicitó en la comisaría Maranga con ubicación Avenida los precursores. El estado de esta incidencia es moderado, con su última actualización a las 11:49 pm del 09/04/2024. Su primera actualización fue a las 10:49 pm el 06/04/2024 con un estado grave . La descripción que el serenazgo adjuntó es la siguiente:
              Descripción en apartado "policía". :
              Descripción en apartado "ambulancia":
              Descripción en apartado "bomberos":<h3>
