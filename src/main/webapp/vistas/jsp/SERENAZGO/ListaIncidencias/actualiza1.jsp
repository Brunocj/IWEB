...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="styles_actualiza1.css">
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
          <div class="card">
            ...
            <h3>Bienvenido, para poder actualizar una incidencia esta debe primero haber sido clasificada. Seleccione "Clasificar" si desea clasificar la incidencia en este momento.</h3>
        ...
        <div class="botones-container">
            <button href="#" onclick="return clasificar();" class="boton-confirmar">Clasificar</button>
    ...
    <script>
      ...
      function cancelar() {
        ...
        function clasificar() {
            Swal.fire({
                title: "¿Estás seguro de que deseas clasificar la incidencia?",
                text: "Una vez clasificada, los datos del sistema serán actualizados",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#00913f",
                cancelButtonColor: "#d33",
                ...
                if (result.isConfirmed) {
                        ...
                        window.location.href = "clasifica.html";
