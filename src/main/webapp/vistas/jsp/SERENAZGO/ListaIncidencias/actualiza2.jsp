...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="styles_actualiza2.css">
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
          <div class="card">
            ...
            <h3>Bienvenido, la información de la clasificación de la incidencia se muestra a continuación. Seleccione "Actualizar" si desea actualizar la clasificación de esta en este momento.</h3>
            <h3>Información:<h3>

            <!-- Radios de categorías -->
            
          <div class="info">
            <h4>De acuerdo con la información ingresada por el serenazgo esta es una incidencia de tipo grave y su última actualización fue a las 10:49 pm el 06/04/2024. Si deseea actualizar seleccione "actualizar".<h3>
            
          </div>
        
        <div class="botones-container">
            <button href="#" onclick="return clasificar();" class="boton-confirmar">Actualizar</button>
    ...
    <script>
      ...
      function cancelar() {
        ...
        function clasificar() {
            Swal.fire({
                title: "¿Estás seguro de que deseas actualizar la incidencia?",
                ...
                if (result.isConfirmed) {    
                        window.location.href = "actualiza3.html";  
                }
            });
